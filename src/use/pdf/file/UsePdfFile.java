...
public class UsePdfFile extends UseFile {
   ...
   */
  public void createPdfFileOnlyText(final String pdfFileName, final String outputText)
      throws IOException {
    /** ドキュメントオブジェクトの作成. */
   ...
   * @throws IOException IOException
   */
  public void getImageFromPdfFile(final String readFileName, final String outputDir)
      throws IOException {
